...
import com.couchbase.labs.grocerycart.activity.CartActivity;
import com.couchbase.labs.grocerycart.activity.MainActivity;
import com.couchbase.labs.grocerycart.adapter.CheckoutCartAdapter;
import com.couchbase.labs.grocerycart.model.Cart;
...
DatabaseManager databaseManager;
    ...
    private void closeProgress() {
        ...
        dbMgr.initCouchbaseLite(getContext());
        dbMgr.openOrCreateDatabase(getContext());
        Map<String, Object> orderMap = new HashMap<>();
        orderMap.put("id",id);
        orderMap.put("orderNo", orderNo);
        orderMap.put("currentDateandTime",currentDateandTime);
        orderMap.put("total","$"+_totalAmount);
        orderMap.put("status","Processed");
        dbMgr.saveOrder(orderMap,"Orders");
        //Save to cblite

        databaseManager.setOrder(orderString);
        databaseManager.deleteCart();
