package com.couchbase.labs.grocerycart.adapter;
...
import com.couchbase.labs.grocerycart.activity.ProductActivity;
import com.couchbase.labs.grocerycart.activity.ProductViewActivity;
                ...
                if (pQuantity >= 1) {
                    ...
                    for (int i = 0; i < cartList.size(); i++) {
                        ...
                        if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                            ...
                            //Log.d("CART", cartStr);
                            databaseManager.setCart(cartStr);
