...
import com.couchbase.labs.grocerycart.interfaces.AddorRemoveCallbacks;
...
//    LocalStorage localStorage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gson = new Gson();
        userJson = databaseManager.getUserLogin();
    ...
    public int cartCount() {
        ...
        gson = new Gson();
        if (databaseManager.getCart() != null) {
            String jsonCart = databaseManager.getCart();
            Log.d("CART : ", jsonCart);
    ...
    public List<Order> getOrderList() {
        if (databaseManager.getOrder() != null) {
            String jsonOrder = databaseManager.getOrder();
            //Log.d("CART : ", jsonCart);
